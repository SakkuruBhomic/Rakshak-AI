"""
Curated forensic emergency scenarios for the Bio-Acoustic Intelligence Dashboard.
Enables immediate visual demonstrations of all 4 dashboard views matching the reference specifications.
"""
...
SCENARIOS = {
    "hinglish_coercion": {
        ...
        "risk_drivers": [
            {"text": "High Trauma Spike Detected", "color": "critical"},
            {"text": "Suppressed Speech Patterns", "color": "high"},
            {"text": "Coercive Language Detected", "color": "critical"},
            {"text": "Elevated Pause Density", "color": "high"},
        ],
        "mean_pitch": 238.4,
        "pitch_std": 64.2,
        ...
        "duress_detection": {
            ...
            "indicators": {
                "low_volume": {"active": True, "label": "LOW VOLUME", "desc": "Abnormally soft speech detected"},
                "high_jitter": {"active": True, "label": "HIGH JITTER", "desc": "Irregular voice instability"},
                "rapid_pauses": {"active": True, "label": "RAPID PAUSES", "desc": "Short, frequent pauses in speech"},
                "suppressed_speech": {"active": True, "label": "SUPPRESSED SPEECH", "desc": "Overall pattern matches duress indicators"}
            },
        ...
        "network_graph": {
            "nodes": [
                {"id": "COERCION", "name": "COERCION", "group": "hub", "radius": 24},
                {"id": "THREAT", "name": "THREAT", "group": "hub", "radius": 20},
                {"id": "PHYSICAL VIOLENCE", "name": "PHYSICAL VIOLENCE", "group": "hub", "radius": 20},
                {"id": "INTIMIDATION", "name": "INTIMIDATION", "group": "hub", "radius": 20},
                {"id": "SUICIDAL IDEATION", "name": "SUICIDAL IDEATION", "group": "hub", "radius": 20},
                {"id": "kill", "name": "kill", "group": "word", "radius": 12},
                {"id": "hurt", "name": "hurt", "group": "word", "radius": 11},
                {"id": "harm", "name": "harm", "group": "word", "radius": 10},
                {"id": "beat", "name": "beat", "group": "word", "radius": 11},
                {"id": "attack", "name": "attack", "group": "word", "radius": 12},
                {"id": "hit", "name": "hit", "group": "word", "radius": 10},
                {"id": "scared", "name": "scared", "group": "word", "radius": 11},
                {"id": "fear", "name": "fear", "group": "word", "radius": 11},
                {"id": "pressure", "name": "pressure", "group": "word", "radius": 10},
                {"id": "end it", "name": "end it", "group": "word", "radius": 11},
                {"id": "die", "name": "die", "group": "word", "radius": 11},
                {"id": "kill myself", "name": "kill myself", "group": "word", "radius": 12},
            ],
            "links": [
                {"source": "COERCION", "target": "THREAT", "value": 3},
                {"source": "COERCION", "target": "PHYSICAL VIOLENCE", "value": 3},
                {"source": "COERCION", "target": "INTIMIDATION", "value": 3},
                {"source": "COERCION", "target": "SUICIDAL IDEATION", "value": 3},
                {"source": "THREAT", "target": "kill", "value": 2},
                {"source": "THREAT", "target": "hurt", "value": 2},
                {"source": "THREAT", "target": "harm", "value": 2},
                {"source": "PHYSICAL VIOLENCE", "target": "beat", "value": 2},
                {"source": "PHYSICAL VIOLENCE", "target": "attack", "value": 2},
                {"source": "PHYSICAL VIOLENCE", "target": "hit", "value": 2},
                {"source": "INTIMIDATION", "target": "scared", "value": 2},
                {"source": "INTIMIDATION", "target": "fear", "value": 2},
                {"source": "INTIMIDATION", "target": "pressure", "value": 2},
                {"source": "SUICIDAL IDEATION", "target": "end it", "value": 2},
                {"source": "SUICIDAL IDEATION", "target": "die", "value": 2},
                {"source": "SUICIDAL IDEATION", "target": "kill myself", "value": 2}
            ]
        },
        "trauma_density_intervals": [
            {"interval": "00:00 - 01:00", "stress": 25, "level": "LOW", "color": "#10b981"},
            {"interval": "01:00 - 02:00", "stress": 48, "level": "MODERATE", "color": "#eab308"},
            {"interval": "02:00 - 03:00", "stress": 85, "level": "EXTREME", "color": "#ef4444"},
            {"interval": "03:00 - 04:00", "stress": 72, "level": "HIGH", "color": "#f97316"},
            {"interval": "04:00 - 05:00", "stress": 92, "level": "EXTREME", "color": "#ef4444"}
        ],
        "detected_threats": ["kill", "beat", "hit", "hurt", "scared", "die", "money"]
    },
    ...
    "physical_extortion": {
        ...
        "action_protocol": "IMMEDIATE POLICE INTERVENTION (PCR VAN DISPATCH) & DLSA LEGAL EMERGENCY ALERT",
        "risk_drivers": [
            {"text": "Trauma Spike Detected at 04:35", "color": "critical"},
            {"text": "Direct Physical Violence Threats", "color": "critical"},
            {"text": "Extreme Loudness Burst Cycles", "color": "high"},
            {"text": "Voice Stability Breakdown (81% Unstable)", "color": "high"},
        ],
        "mean_pitch": 312.0,
        "pitch_std": 88.5,
        "pitch_series": [210, 240, 270, 310, 350, 390, 420, 380, 320, 290, 330, 400, 430, 410, 350, 280, 240, 310, 390, 440, 420, 360, 300, 270, 260],
        "jitter_percent": 3.12,
        ...
        "duress_detection": {
            ...
            "alert_text": "POSSIBLE COERCION DETECTED: Silent alert sent to law enforcement. Caller not notified.",
            "indicators": {
                "low_volume": {"active": False, "label": "LOW VOLUME", "desc": "Acoustic screaming / shouting detected"},
                "high_jitter": {"active": True, "label": "HIGH JITTER", "desc": "Severe vocal micro-instability"},
                "rapid_pauses": {"active": True, "label": "RAPID PAUSES", "desc": "Rapid dyspneic gasping"},
                "suppressed_speech": {"active": True, "label": "SUPPRESSED SPEECH", "desc": "Imminent violence stress signature"}
            },
            "voice_pattern_comparison": {
        ...
        "network_graph": {
            "nodes": [
                ...
                {"id": "INTIMIDATION", "name": "INTIMIDATION", "group": "hub", "radius": 20},
                {"id": "SUICIDAL IDEATION", "name": "SUICIDAL IDEATION", "group": "hub", "radius": 20},
                {"id": "weapon", "name": "weapon", "group": "word", "radius": 13},
                {"id": "kill", "name": "kill", "group": "word", "radius": 14},
                {"id": "attack", "name": "attack", "group": "word", "radius": 12},
                {"id": "break", "name": "break", "group": "word", "radius": 11},
                {"id": "door", "name": "door", "group": "word", "radius": 10},
                {"id": "help", "name": "help", "group": "word", "radius": 12}
            ],
            "links": [
                {"source": "PHYSICAL VIOLENCE", "target": "weapon", "value": 3},
                {"source": "PHYSICAL VIOLENCE", "target": "kill", "value": 3},
                {"source": "PHYSICAL VIOLENCE", "target": "attack", "value": 3},
                {"source": "INTIMIDATION", "target": "door", "value": 2},
                {"source": "COERCION", "target": "PHYSICAL VIOLENCE", "value": 3}
            ]
        },
        "trauma_density_intervals": [
            {"interval": "00:00 - 01:00", "stress": 38, "level": "MODERATE", "color": "#eab308"},
            {"interval": "01:00 - 02:00", "stress": 62, "level": "HIGH", "color": "#f97316"},
            {"interval": "02:00 - 03:00", "stress": 78, "level": "HIGH", "color": "#f97316"},
            {"interval": "03:00 - 04:00", "stress": 88, "level": "EXTREME", "color": "#ef4444"},
            {"interval": "04:00 - 04:35", "stress": 96, "level": "EXTREME", "color": "#ef4444"}
        ],
        "detected_threats": ["weapon", "kill", "break", "attack", "hurt", "help"]
    }
}
